...
/*   Updated: 2025/09/14 20:05:04 by utouze-b         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	check_rule_n(char *board, char *rules, int r_index, char size)
{
	char	i;
	char	empty;
	char	see;
...
char	solve_n(char *board, char *rules, int index, char size)
{
	char	i;
	char	s;
